...
final class Version20220419131514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticking (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, ticking_day DATE NOT NULL, enter_date TIME DEFAULT NULL, break_date TIME DEFAULT NULL, return_date TIME DEFAULT NULL, exit_date TIME DEFAULT NULL, INDEX IDX_F7AB4A36A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
